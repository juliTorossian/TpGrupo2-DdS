<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p class="mb-4">Cualquier duda o consulta que tengas, no dudes en contactarnos!</p>
        ...
        <div class="col-lg-8 col-md-12">
            <div class="row">
                ...
                <div class="col-md-4 mb-5">
                    <h5 class="text-secondary text-uppercase mb-4">Mantenete informado</h5>
                    <p>Suscribite a nuestro newsletter para no perderte ningun descuento!</p>
                    <form action="">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Tu dirección de email">
                            <div class="input-group-append">
                                <button class="btn btn-primary">Enviar</button>
                            </div>
                        </div>
                    </form>
                    <h6 class="text-secondary text-uppercase mt-4 mb-3">Seguinos en nuestras redes</h6>
                    <div class="d-flex">
